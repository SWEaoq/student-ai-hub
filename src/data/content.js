import { Sparkles, Code, PenTool, Presentation, Cpu, Zap, Layout, Palette, Search, Terminal, Bot } from 'lucide-react';
import { SiOpenai, SiAnthropic, SiNotion, SiGoogle, SiFigma } from 'react-icons/si';
import { CursorIcon, GammaIcon, GensparkIcon, PerplexityIcon, MidjourneyIcon } from '../components/CustomIcons';
...
export const CONTENT = {
    en: {
        ...
        hero: {
            tag: 'University Competition 2025 Winner',
            title1: "DON'T JUST LEARN.",
            title1_accent: "CREATE.",
            title2: "BUILD THE",
            title2_accent: "FUTURE.",
            subtitle: "The ultimate toolkit for students, founders, and creators. From aceing exams to launching your first startup.",
        },
        categories: {
            all: 'All Tools',
    ...
    ar: {
        ...
        hero: {
            tag: 'الفائز بمسابقة الجامعة ٢٠٢٥',
            title1: "لا تدرس وبس..",
            title1_accent: "ابدع.",
            title2: "اصنع",
            title2_accent: "المستقبل.",
            subtitle: "الأدوات اللي تحتاجها، سواء للمذاكرة، للمشاريع الجانبية، أو حتى لو تبي تبدأ ستارت أب.",
        },
        categories: {
            all: 'الكل',
...
export const TOOLS = [
    {
        ...
        content: {
            en: {
                ...
                description: 'Real-time search engine that cites every single source. Better than Google for research.',
                hack: 'Use "Focus Mode" to search only academic papers or Reddit discussions.'
            },
            ar: {
                name: 'Perplexity',
                tag: 'محرك المعرفة',
                description: 'محرك بحث فوري يعطيك المصادر لكل معلومة. أفضل من قوقل بمراحل للبحوث.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Find 5 recent academic papers on [TOPIC] and summarize their key findings.", ar: "ابحث عن 5 أوراق أكاديمية حديثة حول [الموضوع] ولخص نتائجها الرئيسية." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                ...
                description: 'Known for more natural, less robotic writing and exceptional coding abilities.',
                hack: 'Upload your entire lecture notes (PDF) and ask it to create a quiz.'
            },
            ar: {
                name: 'Claude 3.5 Sonnet',
                tag: 'الكاتب البشري',
                description: 'معروف بكتابته الطبيعية جداً (ما تحسها روبوت) وقوي جداً في البرمجة.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Analyze the tone and style of this text: [PASTE TEXT]", ar: "حلل نبرة وأسلوب هذا النص: [الصق النص]" }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'ChatGPT 4o',
                tag: ' The Strategist',
                description: 'Perfect for refining business models, marketing copy, and brainstorming.',
                hack: 'Ask it to "Act as a VC investor" to find holes in your project logic.'
            },
            ar: {
                name: 'ChatGPT 4o',
                tag: 'المخطط الاستراتيجي',
                description: 'ممتاز جداً لترتيب أفكار مشاريعك، كتابة محتوى تسويقي، والعصف الذهني.',
                hack: 'اطلب منه "يتقمص شخصية مستثمر" عشان يطلع لك العيوب في فكرة مشروعك.'
            }
        },
        installation: {
            en: "1. Visit chat.openai.com\n2. Create an OpenAI account.\n3. Upgrade to Plus for GPT-4 access.",
            ar: "1. قم بزيارة chat.openai.com\n2. أنشئ حساب OpenAI.\n3. قم بالترقية إلى Plus للوصول إلى GPT-4."
        },
        examplePrompts: [
            {
                title: { en: "Creative Writing", ar: "الكتابة الإبداعية" },
                prompt: { en: "Write a short story about a time traveler who gets stuck in 2024.", ar: "اكتب قصة قصيرة عن مسافر عبر الزمن علق في عام 2024." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'Notion AI',
                tag: 'Second Brain',
                description: 'All-in-one workspace. AI summarizes notes, plans projects, and writes emails.',
                hack: 'Students get the Personal Pro plan for FREE with a .edu email.'
            },
            ar: {
                name: 'Notion AI',
                tag: 'العقل الثاني',
                description: 'مساحة عمل شاملة. الذكاء الاصطناعي يلخص ملاحظاتك، يرتب مشاريعك، ويكتب إيميلاتك.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Summarize this meeting transcript into action items.", ar: "لخص نص هذا الاجتماع إلى بنود عمل." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'Cursor',
                tag: 'The Code Wizard',
                description: 'Build MVPs faster. It predicts your next code edit across files.',
                hack: 'Use "Composer" (Cmd+I) to generate entire features for your app in one go.'
            },
            ar: {
                name: 'Cursor',
                tag: 'ساحر الكود',
                description: 'ابني تطبيقاتك (MVP) بسرعة خيالية. يتوقع الكود ويعدل في ملفات متعددة.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Write a Python script to scrape data from a website.", ar: "اكتب سكريبت Python لاستخراج البيانات من موقع ويب." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'Midjourney',
                tag: 'Art Director',
                description: 'Generate hyper-realistic images for your presentations, ads, or mockups.',
                hack: 'Use "--v 6.0" for the most realistic photo quality available.'
            },
            ar: {
                name: 'Midjourney',
                tag: 'المخرج الفني',
                description: 'صمم صور واقعية جداً لعروضك التقديمية، إعلاناتك، أو نماذجك.',
                hack: 'استخدم الأمر "--v 6.0" عشان تطلع لك صور بجودة واقعية خرافية.'
            }
        },
        installation: {
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "/imagine prompt: minimal vector logo of a fox, flat design --v 6.0", ar: "/imagine prompt: شعار متجه بسيط لثعلب، تصميم مسطح --v 6.0" }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                ...
                tag: 'Agentic IDE',
                description: 'Let AI Agents build the boring parts of your software architecture.',
                hack: 'Great for prototyping backend logic without writing boilerplate code.'
            },
            ar: {
                name: 'Google Antigravity',
                tag: 'مطور المستقبل',
                description: 'خلي وكلاء الذكاء الاصطناعي يبنون لك البنية التحتية لمشروعك.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Design a scalable architecture for a social media app.", ar: "صمم بنية قابلة للتوسع لتطبيق تواصل اجتماعي." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                ...
                tag: 'Data Analyst',
                description: 'Analyze huge datasets or documents for your research projects.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Analyze this dataset and find trends.", ar: "حلل هذه البيانات وجد الاتجاهات." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'Gamma App',
                tag: 'Pitch Deck Pro',
                description: 'Create investor-ready pitch decks and websites in minutes.',
                hack: 'Use the "Web Page" mode to create a quick landing page for your idea.'
            },
            ar: {
                name: 'Gamma App',
                tag: 'ملعب العروض',
                description: 'سوّي عروض تقديمية للمستثمرين (Pitch Decks) أو مواقع بسيطة بدقائق.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Create a 10-slide pitch deck for a coffee shop startup.", ar: "أنشئ عرضًا تقديميًا من 10 شرائح لشركة ناشئة لمقهى." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                ...
                description: 'Generate deep market reports and competitor analysis "Sparkpages".',
                hack: 'Use this to validate your startup idea against real-time market data.'
            },
            ar: {
                name: 'Genspark',
                tag: 'باحث السوق',
                description: 'طلع تقارير سوقية عميقة وحلل المنافسين بصفحات "Sparkpages".',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Analyze the top 3 competitors in the electric bike market.", ar: "حلل أكبر 3 منافسين في سوق الدراجات الكهربائية." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                ...
                description: 'Generate UI mockups for your app idea just by describing it.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Design a login screen for a fitness app.", ar: "صمم شاشة تسجيل دخول لتطبيق لياقة بدنية." }
            }
        ]
    },
    {
        ...
        content: {
            en: {
                name: 'UXPilot',
                tag: 'UX Consultant',
                description: 'Analyze your app screenshots for usability issues before launching.',
                hack: 'Great for getting "professional" feedback on your side project UI.'
            },
            ar: {
                name: 'UXPilot',
                tag: 'مستشار التجربة',
                description: 'حلل صور تطبيقك عشان تكتشف مشاكل الاستخدام قبل ما تطلق المشروع.',
        ...
        examplePrompts: [
            {
                ...
                prompt: { en: "Audit this checkout flow for friction points.", ar: "دقق مسار الدفع هذا بحثًا عن نقاط الاحتكاك." }
            }
        ]
    }
];
